...
const companyLogos = [
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 24" width="75" height="18" fill="currentColor" style={{ display: 'block' }}>
        <path d="M0 20h5v-5.5h4.5v-4H5V6.5h6V2.5H0v17.5zm16-11c-3.2 0-5.2 2.2-5.2 5.5s2 5.5 5 5.5c2.5 0 4.2-1.2 4.8-3h-4c-.4.5-.8.7-1.4.7-1 0-1.7-.8-1.7-2h7.5v-.6c0-3.5-2-5.8-5-5.8zm-2.5 4.2c.2-1.2.8-2 2-2 1 0 1.5.6 1.7 2h-3.7zM27 20h5V2.5h-5V20zm11.5-11c-2.5 0-4.5 1.5-5 3.7V2.5h-5V20h5v-6.6c0-2.5 1.6-3.8 3.7-3.8h.8v-4.6h-.6zm11.5 11h5v-5.5h4.5v-4H50V6.5h6V2.5H45v17.5zm16-11c-3.2 0-5.2 2.2-5.2 5.5s2 5.5 5 5.5c2.5 0 4.2-1.2 4.8-3h-4c-.4.5-.8.7-1.4.7-1 0-1.7-.8-1.7-2h7.5v-.6c0-3.5-2-5.8-5-5.8zm-2.5 4.2c.2-1.2.8-2 2-2 1 0 1.5.6 1.7 2h-3.7zM76.5 9L74 12.7l-2.5-3.7h-4.8l5 6.3-5 6.7h4.8l2.9-4.2 2.9 4.2H82l-5-6.7 5-6.3h-5.5z"/>
      </svg>
    )
  },
  {
    ...
    color: '#00A0E2',
    svg: (
      <svg viewBox="0 0 110 24" width="85" height="18" fill="currentColor" style={{ display: 'block' }}>
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 24" width="75" height="18" fill="currentColor" style={{ display: 'block' }}>
        <path d="M4 2h14l-2 8H6L4 2zm3.5 11a2.5 2.5 0 1 0 2.5 2.5 2.5 2.5 0 0 0-2.5-2.5zm9 0a2.5 2.5 0 1 0 2.5 2.5 2.5 2.5 0 0 0-2.5-2.5z" fill="#FFE500"/>
        <path d="M28 20V4h10v3h-7v4h6v3h-6v6h-3zm11 0V7.5h3v2.2c.8-1.2 2-1.8 3.3-1.8 1.5 0 2.5.6 3 1.5.8-1 1.8-1.5 3-1.5 2.5 0 4 1.8 4 4.5V20h-3v-7.2c0-1.8-.7-2.6-1.8-2.6s-1.8.8-1.8 2.6V20h-3v-7.2c0-1.8-.7-2.6-1.8-2.6s-1.8.8-1.8 2.6V20h-3zm18 0V7.5h3v2.2c.8-1.2 2-1.8 3.3-1.8 3 0 5.2 2 5.2 5s-2.2 5-5.2 5c-1.2 0-2.2-.6-3-1.8v6.8h-3zm6.5-6.8c1.5 0 2.5-1 2.5-2.6s-1-2.6-2.5-2.6c-.8 0-1.5.4-2 1.2v2.8c.5.8 1.2 1.2 2 1.2z" fill="#FFFFFF"/>
      </svg>
    )
  },
  {
  ...
  },
  {
    ...
    color: '#FFFFFF',
    svg: (
      <svg viewBox="0 0 100 24" width="75" height="18" fill="#FFFFFF" style={{ display: 'block' }}>
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 24" width="75" height="18" fill="#FFFFFF" style={{ display: 'block' }}>
        <path d="M12 2A10 10 0 1 0 22 12 10 10 0 0 0 12 2zm1 14h-2V8h2zm0-10h-2V4h2z" fill="#FFFFFF"/>
        <path d="M28 20V4h5c2.5 0 4.2 1.2 4.2 3.5A3 3 0 0 1 35 10c1.8.8 2.5 2 3 3.8l1 6.2h-3.2l-.8-5.5c-.4-2.5-1.5-3-3-3H31v8.5h-3zm3-11.5h2c1.2 0 1.8-.5 1.8-1.5s-.6-1.5-1.8-1.5h-2v3zm11 11.5V7.5h3v2.2c.8-1.2 2-1.8 3.3-1.8 3 0 5.2 2 5.2 5s-2.2 5-5.2 5c-1.2 0-2.2-.5-3-1.5v6.8h-3zm6.5-6.8c1.5 0 2.5-1 2.5-2.6s-1-2.6-2.5-2.6c-.8 0-1.5.4-2 1.2v2.8c.5.8 1.2 1.2 2 1.2z" fill="#FFFFFF"/>
      </svg>
    )
  },
  {
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 24" width="75" height="18" fill="currentColor" style={{ display: 'block' }}>
        ...
        <path d="M24 20V4h5c3.5 0 6 2 6 5.5s-2.5 5.5-6 5.5h-1.5v5H24zm5-8c1.8 0 2.8-1 2.8-2.5s-1-2.5-2.8-2.5h-1.5v5H29zm12.5 8V7.5h3v2.2c.8-1.2 2-1.8 3.3-1.8 3 0 5.2 2 5.2 5s-2.2 5-5.2 5c-1.2 0-2.2-.5-3-1.5v6.8h-3zm6.5-6.8c1.5 0 2.5-1 2.5-2.6s-1-2.6-2.5-2.6c-.8 0-1.5.4-2 1.2v2.8c.5.8 1.2 1.2 2 1.2zm11 6.8V4h3.5v16H76z" fill="#FFFFFF"/>
      </svg>
    )
  }
]
