...
export const defaultPrograms = [
  {
    ...
    subCourses: [
      {
        id: 'adha',
        slug: 'advanced-diploma-hospital-administration',
        title: 'Advanced Diploma in Hospital Administration & Healthcare Operations (ADHA)',
        icon: '🏥',
        tag: 'Full Management Track',
        duration: '10 / 12 Months',
        eligibility: 'Degree / Any Stream',
        salary: '₹22K-45K/month',
        shortDesc: 'Comprehensive master track covering NABH hospital quality standards, OPD & Ward Management, Front Desk Administration, and Healthcare ERP systems.',
        highlights: ['NABH Quality Audit Guidelines', 'OPD & In-Patient Ward Operations', 'Hospital ERP & Software Systems', 'Patient Care & Crisis Administration'],
        careerRoles: ['Hospital Administrator', 'OPD Operations Manager', 'Patient Relations Manager', 'Healthcare Coordinator'],
      },
      {
        id: 'billing-tpa',
        slug: 'hospital-billing-tpa-operations',
        title: 'Diploma in Hospital Billing, Insurance & TPA Desk Operations',
        icon: '💳',
        tag: 'Healthcare Finance Track',
        duration: '6 / 10 Months',
        eligibility: '10+2 / Degree (Any Stream)',
        salary: '₹18K-35K/month',
        shortDesc: 'Specialized training in Revenue Cycle Management (RCM), Third Party Administrator (TPA) Desk, Cashless Insurance Processing, and Patient Tariff Billing.',
        highlights: ['TPA & Cashless Insurance Desk', 'Hospital Revenue Cycle Management', 'Medical Billing Software (HIS)', 'Insurance Claims & Dispute Resolution'],
        careerRoles: ['Hospital Billing Executive', 'TPA Desk Officer', 'Insurance Claims Associate', 'RCM Billing Specialist'],
      },
      {
        id: 'his-emr',
        slug: 'his-medical-records-emr',
        title: 'Certification in Hospital Information Systems (HIS) & Medical Records (EMR/EHR)',
        icon: '💻',
        tag: 'Digital Healthcare Tech',
        duration: '6 Months',
        eligibility: '10+2 / Any Stream',
        salary: '₹18K-32K/month',
        shortDesc: 'Master modern digital healthcare tools, Electronic Health Records (EHR/EMR), ICD-10 medical coding fundamentals, and hospital data privacy protocols.',
        highlights: ['EMR / EHR Software Practice', 'ICD-10 Medical Coding Basics', 'Hospital Database & Patient Records', 'Healthcare Data Privacy & Security'],
        careerRoles: ['Medical Records Officer (MRO)', 'HIS Operations Specialist', 'Healthcare Data Executive', 'EMR Systems Associate'],
      },
      {
        id: 'patient-care-nabh',
        slug: 'patient-care-nabh-quality-standards',
        title: 'Executive Diploma in Patient Care Administration & NABH Quality Standards',
        icon: '🛡️',
        tag: 'Quality & Patient Experience',
        duration: '6 / 10 Months',
        eligibility: '10+2 / Any Stream',
        salary: '₹18K-38K/month',
        shortDesc: 'Focused on patient experience management, hospital infection safety protocols, front office grooming, emergency admission desk administration, and NABH accreditation.',
        highlights: ['NABH Quality Standards & Compliance', 'Patient Experience & Guest Relations', 'Hospital Infection & Safety Protocols', 'Emergency & Casualty Desk Workflow'],
        careerRoles: ['Patient Experience Executive', 'Guest Relations Officer (GRO)', 'NABH Quality Assistant', 'Emergency Desk Coordinator'],
      },
    ],
  },
  {
    ...
    subCourses: [
      {
        ...
        title: 'Diploma in Talent Acquisition & Corporate Recruitment',
        icon: '🎯',
        tag: 'Sourcing & Hiring Track',
        duration: '6 Months',
        eligibility: 'Degree / Any Stream',
        salary: '₹20K-40K/month',
        shortDesc: 'Master modern candidate sourcing, LinkedIn Recruiter, headhunting techniques, AI hiring tools, interview scheduling, and offer negotiation.',
        highlights: ['LinkedIn Recruiter & Portal Sourcing', 'Technical & Non-Technical Screening', 'Salary Negotiation & Offer Management', 'Applicant Tracking Systems (ATS)'],
        careerRoles: ['Talent Acquisition Specialist', 'Corporate Recruiter', 'HR Placement Officer', 'Technical Sourcer'],
      },
      {
        id: 'payroll-analytics',
        slug: 'payroll-compliance-analytics',
        title: 'Certification in Payroll Management, HR Analytics & Compliance',
        icon: '📊',
        tag: 'Compensation & Legal',
        duration: '6 Months',
        eligibility: 'Degree / Any Stream',
        salary: '₹22K-45K/month',
        shortDesc: 'Hands-on training in PF, ESI, TDS compliance, payroll software (Zoho HR / GreytHR), compensation structuring, and HR analytics dashboards.',
        highlights: ['PF, ESI, Gratuity & Statutory Compliance', 'Automated Payroll Software Training', 'Excel & PowerBI for HR Analytics', 'CTC Structuring & Tax Management'],
        careerRoles: ['Payroll Executive', 'HR Statutory Compliance Officer', 'HR Analytics Associate', 'Compensation Analyst'],
      },
    ],
  },
  {
    ...
    subCourses: [
      {
        id: 'shipping-freight',
        slug: 'shipping-freight-forwarding',
        title: 'Diploma in International Shipping & Freight Forwarding',
        icon: '🚢',
        tag: 'Global Maritime Trade',
        duration: '6 / 10 Months',
        eligibility: '10+2 / Degree (Any Stream)',
        salary: '₹22K-45K/month',
        shortDesc: 'Master ocean & air freight operations, Bill of Lading (B/L) processing, vessel scheduling, container logistics, and EXIM documentation.',
        highlights: ['Bill of Lading & Shipping Documentation', 'Ocean & Air Freight Booking', 'Container Yard (CY) & Port Logistics', 'Incoterms 2020 & EXIM Regulations'],
        careerRoles: ['Freight Forwarding Executive', 'Shipping Operations Officer', 'Export-Import Documentation Specialist', 'Container Logistics Associate'],
      },
      {
        id: 'warehouse-inventory',
        slug: 'warehouse-inventory-management',
        title: 'Diploma in Warehouse Management & Inventory Systems',
        icon: '📦',
        tag: 'Supply Chain Operations',
        duration: '6 Months',
        eligibility: '10+2 / Any Stream',
        salary: '₹18K-35K/month',
        shortDesc: 'Practical training in warehouse layouts, WMS software, barcoding, inventory audits, FIFO/LIFO management, and distribution center workflows.',
        highlights: ['Warehouse Management Systems (WMS)', 'Stock Auditing & Inventory Control', 'Pallet Racking & Material Handling', 'Last-Mile Delivery & Distribution'],
        careerRoles: ['Warehouse Operations Manager', 'Inventory Control Officer', 'Supply Chain Analyst', 'Distribution Executive'],
      },
    ],
  },
  {
    ...
    subCourses: [
      {
        id: 'piping-qc',
        slug: 'piping-inspection-qc',
        title: 'Diploma in Oil & Gas Piping Inspection & QA/QC Engineering',
        icon: '🔧',
        tag: 'Technical Inspection Track',
        duration: '6 / 8 Months',
        eligibility: 'ITI / Diploma / BE / Any Stream',
        salary: '₹28K-60K/month',
        shortDesc: 'Comprehensive technical training in piping isometric drawings, welding inspection, QA/QC documentation, ASME standards, and refinery workflows.',
        highlights: ['Piping Isometric & P&ID Drawings', 'ASME & API Code Compliance', 'Welding Inspection & QC Documentation', 'Pressure Vessel & Offshore Standards'],
        careerRoles: ['Piping Inspector', 'QA/QC Inspector', 'Refinery QC Engineer', 'Welding QC Supervisor'],
      },
      {
        id: 'ndt-testing',
        slug: 'ndt-non-destructive-testing',
        title: 'Advanced Certification in Non-Destructive Testing (NDT Level II)',
        icon: '🧲',
        tag: 'ASNT Level II Certified',
        duration: '4 Months',
        eligibility: 'ITI / Diploma / Degree',
        salary: '₹25K-75K/month',
        shortDesc: 'Certified hands-on NDT training covering Ultrasonic Testing (UT), Radiographic Testing (RT), Magnetic Particle (MT), and Dye Penetrant Testing (PT).',
        highlights: ['Ultrasonic & Radiographic Flaw Detection', 'Magnetic Particle & Penetrant Testing', 'ASNT Level II Exam Preparation', 'Pipeline & Weld Defect Evaluation'],
        careerRoles: ['NDT Inspector Level II', 'Ultrasonic Technician', 'Radiographic Testing Analyst', 'Structural Safety Inspector'],
      },
    ],
  },
]
